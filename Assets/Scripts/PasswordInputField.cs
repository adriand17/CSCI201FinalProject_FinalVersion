...
public class PasswordInputField : MonoBehaviour
{
    ...
    {
        if (inputfield.text == "HH2PN" || inputfield.text == "JK982" || inputfield.text == "LC79K" || inputfield.text == "TB2P1")      // check inputfield contains the string password
        {
            //for register player
        ...
        if (inputfield.text == "MCA82" || inputfield.text == "ASC34" || inputfield.text == "ASD8S" || inputfield.text == "PASD1")      // check inputfield contains the string password
        {
            //for guest player
            Debug.Log("Password accepted");     // just a debug.Log to show that the password is correct (can be removed)
